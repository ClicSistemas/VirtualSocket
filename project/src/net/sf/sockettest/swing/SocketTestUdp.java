...
public class SocketTestUdp extends JPanel /*JFrame*/ {
    ...
    private JLabel logoLabel = new JLabel("VirtualSocket", Util.Logo,
            JLabel.CENTER);
    ...
    private void listen() {
        ...
        setCursor(Cursor.getPredefinedCursor(Cursor.DEFAULT_CURSOR));
		if(multicase) {
			messagesField.setText("> MultiCase Server Joined on Port : "+portNo+ Util.NEW_LINE);
		} else {
    ...
    public void append(String msg) {
        messagesField.append(msg+ Util.NEW_LINE);
