...
public class About extends JPanel /*JFrame*/ {
    ...
    private JLabel versionText = new JLabel(html+"Version",Util.Arrow,JLabel.LEFT);
    private JLabel version = new JLabel(html+": 1.0a", JLabel.LEFT);
    
    private JLabel licenceText = new JLabel(html+"Licence",Util.Arrow,JLabel.LEFT);
    private JLabel licence = new JLabel(html+": GNU General Public License v2.0", JLabel.LEFT);
    
    private JLabel authorText = new JLabel(html+"Author",Util.Arrow,JLabel.LEFT);
    private JLabel author = new JLabel(html+": Clic Sistemas Ltda", JLabel.LEFT);
    
    private JLabel copyrightText = new JLabel(html+"Copyright &copy; 2015-2018 Clic Sistemas Ltda.",Util.Arrow,JLabel.LEFT);
    
    private JLabel websiteText = new JLabel(html+"Website",Util.Arrow,JLabel.LEFT);
    private JLabel website = new JLabel(html+": https://github.com/ClicSistemas/VirtualSocket", JLabel.LEFT);
    
    private JLabel readmeText = new JLabel(html+"ReadMe",Util.Arrow,JLabel.LEFT);
